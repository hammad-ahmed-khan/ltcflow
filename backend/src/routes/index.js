...
router.post(
  "/missed-calls/list",
  passport.authenticate("jwt", { session: false }, null),
  require("./missed-calls").getMissedCalls
);

router.post(
  "/missed-calls/clear",
  passport.authenticate("jwt", { session: false }, null),
  require("./missed-calls").clearMissedCall
);

router.post(
  "/missed-calls/clear-all",
  passport.authenticate("jwt", { session: false }, null),
  require("./missed-calls").clearAllMissedCalls
);

router.post(
  "/missed-calls/mark-retrieved",
  passport.authenticate("jwt", { session: false }, null),
  require("./missed-calls").markAsRetrieved
);
